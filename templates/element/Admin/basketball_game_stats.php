    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="alert alert-info text-center">
                <p class="mb-2"><strong>No game statistics available</strong></p>
                <p class="mb-0 text-muted">Use the buttons above to add box scores and player statistics for this game.</p>
            </div>
        </div>
    </div>
<?php else : ?>
