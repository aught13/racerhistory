<?php $this->assign('title', 'Add Player Season Stats'); ?>
<div class="container-fluid py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Add Player Stats</li>
        </ol>
    </nav>

    <h1 class="mb-3">Add Player Season Stats</h1>
