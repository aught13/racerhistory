 ...
 */
?>
<?php $this->assign('title', 'Edit Player Season Stats'); ?>
<div class="container-fluid py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Player Stats</li>
        </ol>
    </nav>

    <h1 class="mb-3">Edit Player Season Stats</h1>

    <div class="card">
        <div class="card-body">
            <?= $this->Form->create($stat, ['novalidate' => true]) ?>

            <h5 class="mt-3 mb-3">Player Information</h5>
            <div class="row">
                <div class="col-md-12 mb-3">
                    <?= $this->Form->control('team_season_roster_id', [
                        'label' => 'Player *',
                        'options' => $teamSeasonRosters,
                        'empty' => 'Select a player',
                        'class' => 'form-select',
                        'required' => true,
                    ]) ?>
                </div>
