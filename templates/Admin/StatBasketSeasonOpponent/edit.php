 ...
 */
?>
<?php $this->assign('title', 'Edit Opponent Season Stats'); ?>
<div class="container-fluid py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Opponent Stats</li>
        </ol>
    </nav>

    <h1 class="mb-3">Edit Opponent Season Stats</h1>
