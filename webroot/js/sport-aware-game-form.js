...
class SportAwareGameForm {
        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.values) {
                    ...
                    Object.entries(periodKeyMap).forEach(([eavKey, legacyKey]) => {
                        if (data.values[eavKey] !== undefined) {
                            const input = document.getElementsByName(legacyKey)[0];
                            if (input) {
    ...
    updateSportIndicator(sportName) {
        ...
        this.sportIndicator.style.display = 'block';
        this.sportIndicator.querySelector('.alert').className = 'alert alert-info';
    }
    ...
    showError(message) {
        ...
        this.sportIndicator.style.display = 'block';
        this.sportIndicator.querySelector('.alert').className = 'alert alert-warning';
    }
    ...
    renderField(field) {
        ...
        const currentValue =
            this.getExistingFieldValue(field.field_name) || field.default_value || '';
