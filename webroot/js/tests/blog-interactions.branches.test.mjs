import { setupBlogPostCollapse, markBlogPostExpanded } from '../modules/blog-interactions.mjs';
 ...
 */
import * as mod from '../modules/blog-interactions.mjs';
...
test('setupBlogPostCollapse clears view frame and toggles classes', () => {
  ...
  const featured = document.createElement('div'); featured.className = 'blog-featured'; container.appendChild(featured);
  const listItem = document.createElement('div'); listItem.className = 'blog-list-item'; container.appendChild(listItem);
  document.body.appendChild(container);
