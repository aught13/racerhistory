...
describe('Coverage targets 3 - requestSubmit and mapping/min-max branches', () => {
    ...
    `;
        ...
        internals.setContext({ formId: 'srcRS', deleteUrl: '/rs', ids: '[5]', idsName: 'ids[]' });
    ...
    `;
        ...
        const admin = require('../../js/admin');
        const internals = admin.__internals || {};
        internals.setContext({ deleteUrl: '/tmpRS', ids: '[9]', idsName: 'ids[]' });
    ...
    test('sport-aware mapping sets multiple legacy period inputs', async () => {
        ...
        const keys = ['period_1_mur', 'period_1_opp', 'period_2_mur', 'period_2_opp'];
        keys.forEach((k) => {
