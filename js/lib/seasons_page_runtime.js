/*
 * Side-effect-free seasons page runtime.
 *
 * Legacy event wiring lives in ../legacy/seasons-init-loader.mjs and
 * Stimulus wiring lives in controllers/seasons_page_controller.js.
 */
import { ensureSearchBuilderLoaded } from "../legacy/modules/searchbuilder-loader.mjs";
...
function getInitSeasons() {
    ...
    if (!initSeasonsPromise) {
        initSeasonsPromise = import("../legacy/modules/seasons-init.js").then(
            (mod) => mod.default,
        );
    }
